  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link btn btn-outline-dark btn-sm" href="{{route('login')}}">Login</a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-4 mb-3">
                <h2>Rent-Books</h2>
                <a href="{{route('register')}}" class="btn btn-outline-secondary">Ayo Daftar Sekarang</a>
            </div>
        ...
        <div class="row justify-content-center">
            ...
            <form action="{{route('storeMessage')}}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea name ="message" class="form-control" id="messege"> </textarea>
                </div>
